...
class NgWords implements ValidationRule
{
    ...
    public $ngWordsEnglish = [
        ...
        'terrorism', 'treason', 'sedition', 'espionage', 'riot', 'arson', 'kill', 'assassination', 'hijacking', 'sabotage'
    ];

    // Google 翻訳による日本語翻訳
    public $ngWordsJapanese = [
        '忌まわしい', '虐待', '攻撃', '私生児', '雌犬', '偏見', '残虐行為', 'いじめっ子', '臆病', '腐敗',
        '畜生', '死亡予告', '中傷', '劣化', '嫌悪', '不正直', '無礼', '分裂的', '悪',
        'ファシズム', '詐欺', '虐殺', '憎悪表現', '嫌がらせ', '偽善', '不寛容', '不正', '侮辱',
        '馬鹿', '誘拐', '殺す', '嘘', '悪意的', '悪意のある', '殺人', '不快', '無視', 'わいせつ',
        '攻撃的', '抑圧', '迫害', '偏見', '人種差別', 'レイプ', '嫌悪', '詐欺', 'スキャンダラス', '隔離',
        '性差別', '恥ずかしい', '中傷', '奴隷制度', '愚かさ', 'テロリスト', '有毒', '反逆', '不公平', '悪意',
        '卑劣', '暴力', '下品', '邪悪', '排外主義', '中絶', 'アルコール', '薬物', 'ギャンブル', '売春',
        '喫煙', '自殺', 'ポルノグラフィー', '裸', '猥褻', '姦通', '近親相姦', '小児性愛', '獣姦', '腐敗',
        '詐欺まがい', '横領', '贈賄', '恐喝', '偽造', '盗作', '海賊行為', '偽造', '密輸',
        'テロ', 'アホ', '死', 'スパイ行為', '暴動', '放火', '殺害', '暗殺', 'ハイジャック', '妨害'
    ];
