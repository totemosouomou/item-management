...
<li class="curriculum-nav-item">
    ...
    <ul class="curriculum-dropdown">
        <li class="my-1 mx-4"><a href="https://www.techis-learning.jp/top/基礎課題">基礎課題</a></li>
        <li class="my-3 mx-4"><a href="https://www.techis-learning.jp/top/応用課題">応用課題</a></li>
        <li class="my-1 mx-4"><a href="https://www.techis-learning.jp/top/開発課題">開発課題</a></li>
    </ul>
</li>
